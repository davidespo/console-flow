...
var HexColorSchema = z.string().regex(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/);
var NAMED_COLORS = {
  /* Reds */
  red_200: "#ffcdd2",
  red_400: "#ef9a9a",
...
var colorStack = chalk.hex(COLOR_STACK);
...
var toLevel = (ordinal, name, color, lightColor, key) => ({
  ...
  primary: chalk2.hex(color),
  secondary: chalk2.hex(lightColor),
  styledName: chalk2.hex(lightColor)(name)
});
...
var TimestampOptionSchema = z2.union([
  z2.literal("ISO8601"),
  z2.literal("locale"),
  z2.literal("unix"),
  z2.string(),
